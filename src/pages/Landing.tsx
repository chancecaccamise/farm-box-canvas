...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section 
        className="relative h-screen flex items-center justify-center bg-cover sm:bg-[length:120%_auto] bg-no-repeat bg-[position:center_center] sm:bg-[position:center_30%] md:bg-[position:center_25%] lg:bg-[position:center_20%] xl:bg-[position:center_15%]"
