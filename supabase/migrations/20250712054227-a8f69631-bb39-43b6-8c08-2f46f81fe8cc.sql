-- Insert sample products to match the checkout flow
INSERT INTO public.products (name, description, category, price, image, is_available, inventory_count) VALUES
-- Products from ProductSelection page
...
('Farm Fresh Eggs', '1 dozen pasture-raised eggs', 'protein', 6.99, null, true, 100),
('Artisan Sourdough', 'Fresh baked sourdough loaf', 'pantry', 7.99, null, true, 100),
('Local Wildflower Honey', '12 oz raw unfiltered honey', 'pantry', 8.99, null, true, 100),
...
-- Add-ons from OrderSummary page
